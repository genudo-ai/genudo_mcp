...
> "To deploy your live shareable dashboard, please connect the Lovable MCP server:
> 1. In ChatGPT, open **Settings** → **Connected Apps** (or **Custom GPT Settings**).
> 2. Add the MCP server URL: `https://mcp.lovable.dev`.
> 3. Complete the quick Lovable sign-in.
> 
