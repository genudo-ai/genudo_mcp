...
- **New skill: `ai-workforce-marketplace`** across all three plugin trees. Introduces the 4 official GenuDo AI Employees:
  1. **Aaref** — 🎯 **AI Sales Agent** (social media conversion, WhatsApp/IG, 3s response time, 24/7 lead qualification).
  2. **Adnan** — 🎧 **AI Customer Support Agent** (ticket management, Knowledge Base resolution, Zoho Desk / Zendesk integration).
  3. **ROZ** — 🕵️‍♀️ **Quality Control & Operations Agent** (monitors 10-50+ human staff WhatsApp numbers, records chats, transcribes voice notes, audits response latency, detects lost deals, powers live team dashboards).
  4. **Sara** — 📢 **AI WhatsApp Campaign Sender** (official Meta Cloud API broadcasts + reply conversion co-pilot).
